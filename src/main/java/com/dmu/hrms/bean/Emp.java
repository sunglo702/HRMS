...
public class Emp {
    ...
    private String chanDeptState;
    private String chanPosState;
    ...
    public String getChanDeptState() {
        return chanDeptState;
    }

    public void setChanDeptState(String chanDeptState) {
        this.chanDeptState = chanDeptState;
    }

    public String getChanPosState() {
        return chanPosState;
    }

    public void setChanPosState(String chanDeptState) {
        this.chanPosState = chanPosState;
    }
